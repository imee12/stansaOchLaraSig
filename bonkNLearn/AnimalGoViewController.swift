...
class AnimalGoViewController: UIViewController {
    
    @IBOutlet weak var goAnimBtn: UIButton!
...
//        
    ...
    @IBAction func goAnim_click(sender: AnyObject) {
